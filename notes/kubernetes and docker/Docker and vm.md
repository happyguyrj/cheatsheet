...
Docker takes advantage of various features of Linux kernel like namespaces and cgroups. Docker Engine combines the namespaces, cgroups, and UnionFS into a wrapper called a container format. The default container format is libcontainer
